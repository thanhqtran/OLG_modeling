// OLG based on Chapter 9.1 in Mausner and Heer (2009)
// In the first 40 periods, agents supply labor elastically
...
// the consumption-leisure euler is the same as age 39, but the consumption-saving euler is similar to 41
